...
Revision History:
    ...
    Mason Back (masonly) 03-May-2017:
    
        Modified i386.h in order to compile with AMD64 systems.
...
static __inline PKPCR KeGetPcr(VOID)
{
#if NT_UP
...
//
// HACKHACK: Hack to get libcntpr.lib compiled. It calls PsGetCurrentThread
//           which is defined as KeGetCurrentThread. In checked builds, this
//           function will not be expanded and will cause a symbol duplication
//           linker error when compiling ntoskrnl using the built libcntpr.lib.
//
...
// utilize it
//
static __inline ULONG KeIsExecutingDpc(VOID)
{
