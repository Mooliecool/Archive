...
Abstract:
    ...
    and route to a the appropriate registered handler.
...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(INIT,HalpInitBusHandler)                     // NT5 REMOVE
...
//#pragma alloc_text(PAGE,HalpNoQueryBusSlots)                    // NT5 REMOVE
//#pragma alloc_text(PAGE,HalpNoReferenceDeviceHandler)           // NT5 REMOVE
//#pragma alloc_text(PAGE,HaliQueryBusSlots)                      // NT5 REMOVE
...
//
// HaliSuspendHibernateSystem is no longer used in NT 5 kernel.
//
